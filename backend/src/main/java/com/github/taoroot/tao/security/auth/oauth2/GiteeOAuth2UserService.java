...
public class GiteeOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
	...
	public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
		...
		userRequest.getAdditionalParameters().put("client_secret", userRequest.getClientRegistration().getClientSecret());
		userRequest.getAdditionalParameters().put("redirect_uri", userRequest.getClientRegistration().getClientSecret());
		userRequest.getAdditionalParameters().put("redirect_uri", userRequest.getClientRegistration().getClientSecret());
